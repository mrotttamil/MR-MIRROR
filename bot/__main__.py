...
def stats(update, context):
    ...
    stats = f'<b>Bot Uptime:</b> {currentTime}\n' \
            ...
            f'<b>RAM:</b> {memory}%\n' \
            f'<b>Disk:</b> {disk}%'
    update.effective_message.reply_photo("https://telegra.ph/file/5a5cbe60c716f93a65e23.jpg", stats, parse_mode=ParseMode.HTML)
...
'''
    update.effective_message.reply_photo("https://telegra.ph/file/5a5cbe60c716f93a65e23.jpg", start_string, parse_mode=ParseMode.MARKDOWN)
